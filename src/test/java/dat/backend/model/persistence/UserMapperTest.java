...
class UserMapperTest {
    ...
    private final static String URL = "jdbc:mysql://localhost:3306/fogprojekt_test?serverTimezone=CET&allowPublicKeyRetrieval=true&useSSL=false";
    ...
    public static void setUpClass() {
        ...
        try (Connection testConnection = connectionPool.getConnection()) {
            try (Statement stmt = testConnection.createStatement()) {
                ...
                stmt.execute("CREATE DATABASE  IF NOT EXISTS fogprojekt_test;");

                // TODO: Create user table. Add your own tables here
                stmt.execute("CREATE TABLE IF NOT EXISTS fogprojekt_test.user LIKE fogprojekt.user;");
            }
