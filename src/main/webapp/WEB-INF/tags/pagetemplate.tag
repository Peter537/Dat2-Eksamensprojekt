...
<head>
    ...
    <title>Fog | Byg din carport</title>
    <link rel="stylesheet" href="<%=request.getContextPath()%>/css/pagetemplateStyle.css">
    ...
    <link rel="icon" href="<%=request.getContextPath()%>/images/FogLogo.png" type="image/png" sizes="16x16">
    ...
    <nav class="navbar navbar-expand-lg" style="margin-top: -1%; height: var(--header-height)">
        <div class="container">
            <c:if test="${sessionScope.user != null}">
                <c:set var="page" value="${sessionScope.myhome}"/>
            </c:if>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup2">
                <div class="navbar-nav">
                    <c:if test="${sessionScope.user == null }">
                        <a class="nav-item nav-link navtext link" href="${pageContext.request.contextPath}/login.jsp">Log ind</a>
                    </c:if>
                    <c:if test="${sessionScope.user != null }">
                        <a class="nav-item nav-link navtext link" href="${pageContext.request.contextPath}/logout">Log ud</a>
                        <a class="nav-item nav-link navtext link" href="${page}">
    ...
    <div class="container mt-3">
        ...
        <div class="row mt-4">
            ...
            <div class="col">
                ...
                <p>&copy; Johannes Fog A/S 2023</p>
            </div>
            <div class="col">
