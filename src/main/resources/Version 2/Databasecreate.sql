...
CREATE TABLE `carport_order` (
  ...
  KEY `fk_carport_order_orderstatus_idx` (`orderstatus`),
  KEY `fk_carport_order_zipcode_idx` (`zipcode`),
  ...
  CONSTRAINT `fk_carport_order_orderstatus` FOREIGN KEY (`orderstatus`) REFERENCES `orderstatus` (`status`),
  CONSTRAINT `fk_carport_order_roof1` FOREIGN KEY (`fk_roof_id`) REFERENCES `roof` (`id`),
  CONSTRAINT `fk_carport_order_zipcode` FOREIGN KEY (`zipcode`) REFERENCES `zip` (`zipcode`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `carport_order`
--

LOCK TABLES `carport_order` WRITE;
/*!40000 ALTER TABLE `carport_order` DISABLE KEYS */;
INSERT INTO `carport_order` VALUES (1,'PENDING','Horsebakken',2800,'magnus@johannesfog.dk','user@gmail.com',1,300,300,300,300,300,300,NULL,'Please let me work','0000-00-00 00:00:00'),(2,'PENDING','lyngby 4, 2800 Lyngby',2400,NULL,'user@gmail.com',1,300,300,300,NULL,NULL,NULL,NULL,'bruh','0000-00-00 00:00:00'),(3,'PENDING','lyngby 4, 2800 Lyngby',2400,NULL,'user@gmail.com',1,300,300,300,NULL,NULL,NULL,NULL,'bruh','0000-00-00 00:00:00'),(4,'PENDING','lyngby 4, 2800 Lyngby',2400,NULL,'user@gmail.com',1,300,300,300,NULL,NULL,NULL,NULL,'bruh','0000-00-00 00:00:00'),(5,'PENDING','lyngby 4, 2800 Lyngby',2400,NULL,'user@gmail.com',1,300,300,300,NULL,NULL,NULL,NULL,'bruh','0000-00-00 00:00:00');
/*!40000 ALTER TABLE `carport_order` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `carportorderWithAll`
--

DROP TABLE IF EXISTS `carportorderWithAll`;
/*!50001 DROP VIEW IF EXISTS `carportorderWithAll`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `carportorderWithAll` AS SELECT 
 1 AS `id`,
 1 AS `orderstatus`,
 1 AS `address`,
 1 AS `zipcode`,
 1 AS `fk_employee_email`,
 1 AS `fk_customer_email`,
 1 AS `fk_roof_id`,
 1 AS `width`,
 1 AS `length`,
 1 AS `min_height`,
 1 AS `toolroom_width`,
 1 AS `toolroom_length`,
 1 AS `price_from_partslist`,
 1 AS `price`,
 1 AS `remarks`,
 1 AS `created_on`,
 1 AS `status`,
 ...
 1 AS `employeeid`,
 1 AS `employeename`,
 1 AS `work_phonenumber`,
 1 AS `private_phonenumber`,
 1 AS `fk_position`,
 1 AS `fk_department_id`,
 1 AS `position`,
 1 AS `departmentid`,
 1 AS `departmentaddress`,
 1 AS `departmentzip`,
 1 AS `departmentname`,
 1 AS `departmentcity`,
 1 AS `customeremail`,
...
INSERT INTO `customer` VALUES ('alex@hotmail.com',3,'alex','12345',NULL,NULL,NULL,NULL,NULL,NULL,NULL),('allan@outlook.dk',2,'allan','1234',NULL,NULL,NULL,NULL,NULL,NULL,NULL),('ben@gmail.com',1,'ben','123',NULL,NULL,NULL,NULL,NULL,NULL,NULL),('magnus@gmail.com',5,'magnus','test',NULL,NULL,NULL,NULL,NULL,NULL,NULL),('test@gmail.com',4,'Test','1234',NULL,NULL,NULL,NULL,NULL,NULL,NULL),('user@gmail.com',6,'Joe','1234','12345678','lyngby 4',2800,'lyr',2800,'',2400);
/*!40000 ALTER TABLE `customer` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `customerWithAddress`
--

DROP TABLE IF EXISTS `customerWithAddress`;
/*!50001 DROP VIEW IF EXISTS `customerWithAddress`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `customerWithAddress` AS SELECT 
 1 AS `email`,
 1 AS `id`,
 1 AS `name`,
 1 AS `phonenumber`,
...
INSERT INTO `department` VALUES (1,'lyng',2800,'Lyngby');
...
INSERT INTO `employee` VALUES ('magnus@johannesfog.dk',1,'Magnus','4321','1234','87654321','CEO',1);
/*!40000 ALTER TABLE `employee` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `employeeWithDepartment`
--

DROP TABLE IF EXISTS `employeeWithDepartment`;
/*!50001 DROP VIEW IF EXISTS `employeeWithDepartment`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `employeeWithDepartment` AS SELECT 
 1 AS `email`,
 1 AS `id`,
 1 AS `name`,
 1 AS `password`,
...
INSERT INTO `lumber` VALUES (1,300,1,1000),(2,480,1,1000),(3,360,6,1000),(4,300,7,1000),(5,300,8,1000),(6,300,9,1000),(7,480,10,1000),(8,500,2,1000),(9,600,3,1000),(10,460,4,1000),(11,360,5,1000);
...
CREATE TABLE `lumbertype` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `fk_lumbertype_type_idx` (`type`),
  CONSTRAINT `fk_lumbertype_type1` FOREIGN KEY (`type`) REFERENCES `type` (`type`)
...
INSERT INTO `lumbertype` VALUES (1,97,97,'POLE',60),(2,75,75,'POLE',60),(3,90,90,'POLE',76),(4,45,45,'POLE',18),(5,125,125,'POLE',149),(6,45,195,'RAFTER',48),(7,45,245,'RAFTER',82),(8,15,175,'RAFTER',43),(9,15,150,'RAFTER',37),(10,45,125,'RAFTER',31);
...
INSERT INTO `orderstatus` VALUES ('PENDING',1,'afventer');
...
INSERT INTO `position` VALUES ('CEO'),('Lagermedarbejder'),('Sales');
...
CREATE TABLE `roof` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `fk_roof_type1_idx` (`type`),
  CONSTRAINT `fk_roof_type1` FOREIGN KEY (`type`) REFERENCES `type` (`type`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `roof` VALUES (1,100,'PLASTIC_ROOF');
...
INSERT INTO `type` VALUES ('PLASTIC_ROOF','Plastic tag'),('POLE','Stolpe'),('RAFTER','Spærtræ');
...
/*!50001 VIEW `carportorderWithAll` AS select `co`.`id` AS `id`,`co`.`orderstatus` AS `orderstatus`,`co`.`address` AS `address`,`co`.`zipcode` AS `zipcode`,`co`.`fk_employee_email` AS `fk_employee_email`,`co`.`fk_customer_email` AS `fk_customer_email`,`co`.`fk_roof_id` AS `fk_roof_id`,`co`.`width` AS `width`,`co`.`length` AS `length`,`co`.`min_height` AS `min_height`,`co`.`toolroom_width` AS `toolroom_width`,`co`.`toolroom_length` AS `toolroom_length`,`co`.`price_from_partslist` AS `price_from_partslist`,`co`.`price` AS `price`,`co`.`remarks` AS `remarks`,`co`.`created_on` AS `created_on`,`o`.`status` AS `status`,`o`.`displayname` AS `displayname`,`o`.`sortvalue` AS `sortvalue`,`z`.`city_name` AS `city_name`,`e`.`email` AS `employeeemail`,`e`.`id` AS `employeeid`,`e`.`name` AS `employeename`,`e`.`work_phonenumber` AS `work_phonenumber`,`e`.`private_phonenumber` AS `private_phonenumber`,`e`.`fk_position` AS `fk_position`,`e`.`fk_department_id` AS `fk_department_id`,`e`.`position` AS `position`,`e`.`departmentid` AS `departmentid`,`e`.`address` AS `departmentaddress`,`e`.`zipcode` AS `departmentzip`,`e`.`departmentname` AS `departmentname`,`e`.`city_name` AS `departmentcity`,`c`.`email` AS `customeremail`,`c`.`id` AS `customerid`,`c`.`name` AS `customername`,`c`.`phonenumber` AS `phonenumber`,`c`.`address_1` AS `address_1`,`c`.`zipcode_1` AS `zipcode_1`,`c`.`city_1` AS `city_1`,`c`.`address_2` AS `address_2`,`c`.`zipcode_2` AS `zipcode_2`,`c`.`city_2` AS `city_2`,`c`.`address_3` AS `address_3`,`c`.`zipcode_3` AS `zipcode_3`,`c`.`city_3` AS `city_3`,`r`.`id` AS `roofid`,`r`.`squaremeter_price` AS `squaremeter_price`,`r`.`type` AS `type` from (((((`carport_order` `co` join `orderstatus` `o` on((`co`.`orderstatus` = `o`.`status`))) join `zip` `z` on((`co`.`zipcode` = `z`.`zipcode`))) join `employeeWithDepartment` `e` on((`co`.`fk_employee_email` = `e`.`email`))) join `customerWithAddress` `c` on((`co`.`fk_customer_email` = `c`.`email`))) join `roof` `r` on((`co`.`fk_roof_id` = `r`.`id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `customerWithAddress`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`dev`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `customerWithAddress` AS select `customer`.`email` AS `email`,`customer`.`id` AS `id`,`customer`.`name` AS `name`,`customer`.`phonenumber` AS `phonenumber`,`customer`.`address_1` AS `address_1`,`customer`.`zipcode_1` AS `zipcode_1`,`z1`.`city_name` AS `city_1`,`customer`.`address_2` AS `address_2`,`customer`.`zipcode_2` AS `zipcode_2`,`z2`.`city_name` AS `city_2`,`customer`.`address_3` AS `address_3`,`customer`.`zipcode_3` AS `zipcode_3`,`z3`.`city_name` AS `city_3` from (((`customer` left join `zip` `z1` on((`customer`.`zipcode_1` = `z1`.`zipcode`))) left join `zip` `z2` on((`customer`.`zipcode_2` = `z2`.`zipcode`))) left join `zip` `z3` on((`customer`.`zipcode_3` = `z3`.`zipcode`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `employeeWithDepartment`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`dev`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `employeeWithDepartment` AS select `e`.`email` AS `email`,`e`.`id` AS `id`,`e`.`name` AS `name`,`e`.`password` AS `password`,`e`.`work_phonenumber` AS `work_phonenumber`,`e`.`private_phonenumber` AS `private_phonenumber`,`e`.`fk_position` AS `fk_position`,`e`.`fk_department_id` AS `fk_department_id`,`p`.`position` AS `position`,`d`.`id` AS `departmentid`,`d`.`address` AS `address`,`d`.`zipcode` AS `zipcode`,`d`.`name` AS `departmentname`,`z`.`city_name` AS `city_name` from (((`employee` `e` join `position` `p` on((`e`.`fk_position` = `p`.`position`))) join `department` `d` on((`e`.`fk_department_id` = `d`.`id`))) join `zip` `z` on((`d`.`zipcode` = `z`.`zipcode`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2023-05-22 13:10:29
